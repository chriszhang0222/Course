...
public class VodUtil {
     ...
     */
    public static DefaultAcsClient initVodClient(String accessKeyId, String accessKeySecret) throws com.aliyuncs.exceptions.ClientException {
     ...
     * @throws com.aliyuncs.exceptions.ClientException
     */
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient, String fileName) throws com.aliyuncs.exceptions.ClientException {
...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000172412L);
        request.setTemplateGroupId("f3e3077dcbe100cb90da5f88ef5743ce");
    ...
    public static void main(String[] args) {
        String accessKeyId = "LTAI4G3uxp6jrbuogmQYSDEy";
        String accessKeySecret = "fg4zPj3Met2KTpr3UqwX4RrMf3RTpC";
        String localFile = "/Users/chris/file/imooc_course/course/file_test.mov";
        try{
            DefaultAcsClient vodClient = initVodClient(accessKeyId, accessKeySecret);
            String fileName = "file_test.mov";
